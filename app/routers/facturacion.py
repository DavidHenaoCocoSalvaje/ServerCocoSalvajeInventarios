...
@router.get(
    ...
    response_model=bool,
    summary='Verifica si una compra ha sido registrada.',
    description='Verifica si una compra ha sido registrada.',
    tags=[Tags.INVENTARIO],
    dependencies=[Depends(validar_access_token)],
)
async def compra_registrada(compra_provider_number: str, session: AsyncSession = Depends(get_async_session)) -> bool:
...
if __name__ == '__main__':
    ...
    async def main():
        invoice_json_string = '{ "body": { "id": "MI171003415", "uuid": "d053a7fdf3b684c20662ad55916271cf7b4d2210f67f86831b00e8801269c486e4e649a3a2b43795e380367340f7671a", "fecha": "2025-10-07", "emisor": { "razonsocial": "Cencosud Colombia S.A.", "nombrecomercial": "Cencosud Colombia S.A.", "telefono": "601", "email": "recepcionfacturaselectronicas@cencosud.com.co", "documento": "900155107", "digitoverificacion": "1", "tipodocumento": "31", "responsabilidadesfiscales": "O-13;O-15;O-23", "nameresponsabilidadesfiscales": "Gran contribuyente; Autorretenedor; Agente de retención IVA", "esquematributario": { "id": "01", "name": "IVA" }, "pais": "Colombia", "departamento": "Cundinamarca", "ciudad": "Bogota DC", "ciudad_id": "11001", "address": "Av 9 125 - 30" }, "receptor": { "razonsocial": "COCO SALVAJE S.A.S", "documento": "900912246" }, "moneda": "COP", "subtotal": "648363.00", "total": 771552, "descuento": 0, "impuestos": [ { "id": "01", "impuesto": "IVA", "base": "648363.00", "porcentaje": "19.00", "monto": "123188.97" } ], "lineitems": [ { "nombre": "COCOA CORONA *230G", "cantidad": "6.0000", "valorunitario": "13949.50", "total": 83697, "unidad": "NIU", "cantidadbase": "6.0000", "impuestos": [ { "id": "01", "impuesto": "IVA", "base": "83697.00", "porcentaje": "19.00", "monto": "15902.43" } ], "descripcion": "El vinilo adhesivo mate es una lámina de PVC autoadherible con acabado opaco, ideal para rotulación, decoración y personalización, que reduce reflejos y proyecta un estilo moderno, sobrio y profesional\\nwww.printdepot.mx\\n+1\\n .", "nombre_unidad": "número de unidades internacionales", "inventario": "MPM004", "cuenta": "", "kg": 1.38, "und": "" }, { "nombre": "RECOLECTOR DE ORINA DEXCO", "cantidad": "50", "valorunitario": "847.0600", "total": 42353, "unidad": "94", "cantidadbase": "50", "impuestos": [ { "id": "01", "impuesto": "IVA", "base": "42353.0000", "porcentaje": "19.00", "monto": "8047.0700" } ], "nombre_unidad": "número de unidades internacionales", "inventario": "", "cuenta": "529595", "kg": "", "und": 50 } ], "pago": "1", "fechapago": "2025-10-07" }, "headers": { "authorization": "**hidden**", "accept": "application/json,text/html,application/xhtml+xml,application/xml,text/*;q=0.9, image/*;q=0.8, */*;q=0.7" }, "method": "POST", "uri": "https://api.cocosalvajeapps.com/facturacion/compra", "gzip": true, "rejectUnauthorized": true, "followRedirect": true, "resolveWithFullResponse": true, "followAllRedirects": true, "timeout": 300000, "encoding": null, "json": false, "useStream": true }'
