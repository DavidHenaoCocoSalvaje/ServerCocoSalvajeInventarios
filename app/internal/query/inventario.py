...
from app.internal.query.base import BaseQuery, ModelDB
...
class BaseQueryWithShopifyId(BaseQuery, Generic[ModelDB]):
...
class PrecioPorVarianteQuery(BaseQuery[PreciosPorVariante]):
...
class MovimientoQuery(BaseQuery[Movimiento]):
    def __init__(self) -> None:
